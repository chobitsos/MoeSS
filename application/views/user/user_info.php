            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <p>充值邀请码：<input type="text" maxlength="20" class="form-control" id="charge_code" name="charge_code" required > <button type="submit"class="btn btn-info btn-sm">充值</button></p>
                    </div><!-- /.box -->
                </div>
            </div>
    </section><!-- /.content -->
