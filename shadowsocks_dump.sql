...
INSERT INTO `invite_code` VALUES (1,'DZROGM1MmQ1ZjYyMDU2ODRhNDcz',1,1,1,'d5aaron'),(2,'DZRM2QwOGU5NTkzOTdhZGYzNGIx',1,0,1,NULL),(3,'LCSNDcxMThkYWViYzViMTYyNjkw',1,1,1,'lihuaigang'),(4,'LCSZDNiYjAwMmFjZDhkN2RkMDk1',1,0,1,NULL),(5,'LCSOTkwZTQ0MWYwZmI2ZjNmYWQ3',1,0,1,NULL),(6,'LCSZjdhYmMxOGZjYjQzOTc1MDY1',1,0,1,NULL),(7,'LCSGVjY2E1ZWQzZDZiODA3OWUyZ',1,0,1,NULL),(8,'LCSOWUzYmIxMmQyMDNmNDVhOTEy',1,0,1,NULL),(9,'LCSlNDFlZTdiMDgzMzU4ODM5OWI',1,0,1,NULL),(10,'LCSjRjNTE3M2MyY2UxN2ZkOGZjZ',1,0,1,NULL),(11,'LCSQ0YmE4ZjA5MzZjMjBiZDc5MT',1,0,1,NULL),(12,'LCS4OTcwNWFlNmQ3NDNiZjFlODQ',1,0,1,NULL),(13,'LCSWQ1YjZkYjgzYmU3OGVmYjBkM',1,0,1,NULL),(14,'LCSN2ZlYWY3N2E5N2ZjMzhmMzQy',1,0,1,NULL),(15,'LCSMjI0NWUyYWY0MzFmYjdiNjcy',1,0,1,NULL),(16,'LCSmJhZTQwYTU3NzkyOGI3NmQyZ',1,0,1,NULL),(17,'LCShNGE3NzYyMTQ1MGFhODRmZWU',1,0,1,NULL),(18,'LCSMDI2NWM3MTJjNDlkNTFhMThh',1,0,1,NULL),(19,'LCSU2NTk3MmRjZTY4ZGFkNGQ1Mm',1,0,1,NULL),(20,'LCSzE1MGRlY2JkODliMGY1NDQyY',1,0,1,NULL),(21,'LCSOGQ0N2Q0MTJiY2JlZWNlM2Q5',1,0,1,NULL),(22,'LCSE4YTMzMDYwN2Q3Njc5NmIzNW',1,0,1,NULL);
...
INSERT INTO `options` VALUES (1,'invite_only','true','邀请注册'),(2,'default_transfer','5368709120','默认流量(Byte)'),(3,'default_invite_number','1','默认邀请数量'),(4,'check_min','50','签到下限(MB)'),(5,'check_max','100','签到上限(MB)'),(6,'version','1.1','程序版本'),(7,'mail_protocol','smtp','邮件引擎'),(8,'mail_mailpath','/usr/sbin/sendmail','Sendmail路径'),(9,'mail_smtp_host','smtp.163.com','SMTP服务器'),(10,'mail_smtp_user','d5aaron@163.com','SMTP用户名'),(11,'mail_smtp_pass','!Aaron190','SMTP密码'),(12,'mail_smtp_port','25','SMTP端口'),(13,'mail_smtp_crypto','','SMTP加密方法'),(14,'mail_sender_address','d5aaron@163.com','发件邮箱'),(15,'mail_sender_name','Freeland','发件人姓名'),(16,'mail_sg_user','api_user','SendGrid API User'),(17,'mail_sg_pass','api_key','SendGrid API Key');
...
INSERT INTO `user` VALUES (1,'admin','d5aaron@163.com','583c36a5707409c41026f24dd7df3b63','A','00000000',1460434177,4185,0,5368709120,14000,1,1,7,0,0,0,'2015-01-01 00:00:00',0,'0.00'),(2,'d5aaron','d5aaron@163.com','583c36a5707409c41026f24dd7df3b63','A','146711',1460435364,3283034,28062037,55008296960,14006,1,1,7,0,1460171837,0,'2016-04-07 20:33:23',1,'0.00'),(3,'lihuaigang','jingshenbing5211@163.com','6c88da1cc6d9bfbb95c4fcfceddca262','A','889376',1460434177,459717,11303435,5446303744,14012,1,1,7,0,1460099215,0,'2016-04-08 15:05:51',1,'0.00');
...
-- Dump completed on 2016-04-12 12:29:43
